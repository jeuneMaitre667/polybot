...
# Usage: .\deploy-bot.ps1 -KeyPath "C:\Users\cedpa\Downloads\LightsailDefaultKey-eu-west-1.pem" -Ip "63.34.0.38"
...
Write-Host "  3. pm2 restart poly-engine"
Write-Host "Logs : pm2 logs poly-engine"
