...
# Usage: .\deploy-bot.ps1 -KeyPath "C:\Users\cedpa\Downloads\LightsailDefaultKey-eu-west-1.pem" -Ip "34.253.187.142"
...
if (-not $Ip) {
    $Ip = Read-Host "IPv4 publique de l'instance Lightsail (ex: 34.253.187.142)"
}
