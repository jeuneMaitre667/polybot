...
Sur la page **Connect** de ton instance, note l’**IPv4** (ex. `63.34.0.38`).
...
.\deploy-bot.ps1 -KeyPath "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" -Ip "63.34.0.38"
```
...
```powershell
ssh -i "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" ubuntu@63.34.0.38
```
