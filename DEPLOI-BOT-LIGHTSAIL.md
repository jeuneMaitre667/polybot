...
Sur la page **Connect** de ton instance, note l’**IPv4** (ex. `108.130.195.85`).
...
.\deploy-bot.ps1 -KeyPath "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" -Ip "108.130.195.85"
```
...
```powershell
ssh -i "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" ubuntu@108.130.195.85
```
