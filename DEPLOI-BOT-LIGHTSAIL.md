...
Sur la page **Connect** de ton instance, note l’**IPv4** (ex. `34.242.214.109`).
...
.\deploy-bot.ps1 -KeyPath "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" -Ip "34.242.214.109"
```
...
```powershell
ssh -i "$env:USERPROFILE\Downloads\LightsailDefaultKey-eu-west-1.pem" ubuntu@34.242.214.109
```
